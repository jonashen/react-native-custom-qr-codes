...
class Eyes extends React.Component {
  constructor(props) {
    super(props);
    /* Outside padding of QR code */
    this.padding = 7;

    /* XY coordinates (right-to-bottom) */
    this.x = this.props.x ? this.props.x : 0;
    this.y = this.props.y ? this.props.y : 0;
    this.topLeftCorner = [this.padding + this.x, this.padding + this.y];
    ...
    /* Coordinates of inner shapes */
    this.innerEyeCoord = [7.5, 7.5];
    this.insideEyeCoord = [6, 6];

    this.outerEyeStyle = this.props.outerEyeStyle;
    this.innerEyeStyle = this.props.innerEyeStyle;
  }
    ...
    return (
      <Container>
        <EyeShape
          ...
          size={this.outerSize}
          leftCornerX={this.topLeftCorner[0]}
          leftCornerY={this.topLeftCorner[1]}
          color="black"
        >
          <EyeShape
            type={this.outerEyeStyle}
            size={this.innerSize}
            leftCornerX={this.innerEyeCoord[0]}
            leftCornerY={this.innerEyeCoord[1]}
            color="white"
          >
            <EyeShape
              type={this.innerEyeStyle}
              size={this.insideSize}
              leftCornerX={this.insideEyeCoord[0]}
              leftCornerY={this.insideEyeCoord[1]}
              color="black"
            />
          </EyeShape>
        </EyeShape>
